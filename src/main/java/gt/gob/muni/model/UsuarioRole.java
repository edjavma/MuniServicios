...
@Entity
@NamedQueries({
	@NamedQuery(name = "UsuarioRole.findAll",
				query = "SELECT r FROM UsuarioRole r WHERE r.estado = 'A' "),
	@NamedQuery(name = "UsuarioRole.findById",
				query = "SELECT r FROM UsuarioRole r WHERE r.idUsuarioRole = :idUsuarioRole "),
	@NamedQuery(name = "UsuarioRole.findByUsuario",
				query = "SELECT r FROM UsuarioRole r WHERE r.idUsuario.idUsuario = :idUsuario "),
	@NamedQuery(name = "UsuarioRole.findRolesByUsuario",
				query = "SELECT r FROM UsuarioRole u INNER JOIN u.idRole r WHERE u.idUsuario.idUsuario = :idUsuario AND u.estado = 'A' "),
	@NamedQuery(name = "UsuarioRole.findByUsuarioByRole",
